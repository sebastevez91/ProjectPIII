...
{
<<<<<<<< HEAD:AutoPartesRazor/Migrations/20251130005323_InitialCreateDB.cs
    public partial class InitialCreateDB : Migration
========
    public partial class createBD : Migration
>>>>>>>> 0bf5ff7de7fa453f33c0ec71764976b3257a96e4:AutoPartesRazor/Migrations/20251205021056_createBD.cs
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Claims_AspNetUsers_AdministradorAsignadoId",
                        column: x => x.AdministradorAsignadoId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Claims_AspNetUsers_ClienteId",
...
<<<<<<<< HEAD:AutoPartesRazor/Migrations/20251130005323_InitialCreateDB.cs
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MensajeReclamo_Claims_ReclamoId",
...
>>>>>>>> 0bf5ff7de7fa453f33c0ec71764976b3257a96e4:AutoPartesRazor/Migrations/20251205021056_createBD.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_AdministradorAsignadoId",
                table: "Claims",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_Estado",
                table: "Claims",
                column: "Estado");

            migrationBuilder.CreateIndex(
                name: "IX_Claims_Estado_NivelUrgencia_FechaCreacion",
                table: "Claims",
                columns: new[] { "Estado", "NivelUrgencia", "FechaCreacion" });

            migrationBuilder.CreateIndex(
                name: "IX_Claims_FechaCreacion",
                table: "Claims",
                column: "FechaCreacion");

            migrationBuilder.CreateIndex(
                name: "IX_Claims_NivelUrgencia",
                table: "Claims",
                column: "NivelUrgencia");

            migrationBuilder.CreateIndex(
                name: "IX_Claims_NumeroTicket",
                table: "Claims",
                column: "NumeroTicket",
                unique: true);
